...
static const char *dmenucmd[] = { "/home/vitt/.local/bin/dwm/dmenu-apps", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
...
static const Key keys[] = {
  ...
  { MODKEY,                       XK_n,      spawn,          {.v = wallswitchcmd } },
